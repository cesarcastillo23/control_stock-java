...
public class ProductoDAO {
    ...
    public List<Producto> listar() {
        ...
        try {
            final PreparedStatement statement = con.prepareStatement("SELECT ID, NOMBRE, DESCRIPCION," +
    ...
    public List<Producto> listar(Integer categoriaId) {
        List<Producto> resultado =new ArrayList<>();
        try {
            var querySelector ="SELECT ID, NOMBRE, DESCRIPCION," +
                    " CANTIDAD FROM PRODUCTO WHERE CATEGORIA_ID=?";
